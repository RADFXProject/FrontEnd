                    ...
                    <form className={classes.root} noValidate autoComplete="off">
                        ...
                        <Box sx={{ flexGrow: 1 }} style={{ padding: '1rem' }}>
                            <Grid container spacing={2}>
                                ...
                                <Grid item xs={12}>
                                    <TextField id="standard-required" label="First name" defaultValue="" variant="standard" />
                                    <TextField id="standard-required" label="Last name" defaultValue="" variant="standard" />
                        ...
                        <Box sx={{ flexGrow: 1 }} style={{ padding: '1rem' }}>
                            <Grid container spacing={2}>
                                ...
                                <Grid item xs={12}>
                                    <TextField id="standard-required" label="Name" defaultValue="" variant="standard" />
                                    <TextField id="standard-required" label="Email" defaultValue="" variant="standard" />
                                    <TextField id="standard-required" label="Phone" defaultValue="" variant="standard" />
                                </Grid>
                                <Grid item xs={12}>
